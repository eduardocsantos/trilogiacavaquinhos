...
?>
		...
		<em class="comment-awaiting-moderation"><?php _e( 'Seu comentário foi enviado, em breve será publicado, Obrigado  =]  ' ) ?></em>
		<br />
		<?php endif; ?>
		...
		<<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'parent' : '' ); ?>>
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				<footer class="comment-meta">
					...
					<?php if ( '0' == $comment->comment_approved ) : ?>
					<p class="comment-awaiting-moderation"><?php _e( 'Seu comentário foi enviado, em breve será publicado, Obrigado  =] ' ); ?></p>
					<?php endif; ?>
				</footer><!-- .comment-meta -->
